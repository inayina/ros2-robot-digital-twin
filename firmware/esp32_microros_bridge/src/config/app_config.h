...
constexpr float kMotorControlDefaultMaxPwm = 0.35f;
...
constexpr bool kEnableN20OpenLoopPwmSweep = false;
...
constexpr unsigned long kN20OpenLoopSweepStepMs = 2000UL;
constexpr unsigned long kN20OpenLoopSweepPrintIntervalMs = 100UL;
constexpr float kN20OpenLoopSweepPwm0 = 0.15f;
constexpr float kN20OpenLoopSweepPwm1 = 0.20f;
constexpr float kN20OpenLoopSweepPwm2 = 0.25f;
constexpr float kN20OpenLoopSweepPwm3 = 0.30f;
constexpr float kN20OpenLoopSweepPwm4 = 0.35f;
constexpr float kN20OpenLoopSweepPwm5 = 0.40f;
constexpr float kN20OpenLoopSweepPwm6 = 0.45f;
...
constexpr float kN20ClosedLoopBenchMaxPwm = 0.35f;
constexpr float kN20ClosedLoopBenchMinEffectivePwm = 0.12f;
constexpr float kN20ClosedLoopBenchMaxTargetRpm = 100.0f;
...
constexpr float kN20ClosedLoopBenchProfileStep1TargetRpm = 50.0f;
constexpr float kN20ClosedLoopBenchProfileStep2TargetRpm = 70.0f;
constexpr float kN20ClosedLoopBenchProfileStep3TargetRpm = 100.0f;
constexpr float kN20ClosedLoopBenchProfileStep4TargetRpm = 80.0f;
constexpr float kN20ClosedLoopBenchProfileStep5TargetRpm = 0.0f;
constexpr float kN20ClosedLoopBenchKp = 0.0030f;
constexpr float kN20ClosedLoopBenchKi = 0.0020f;
constexpr float kN20ClosedLoopBenchKd = 0.0f;
constexpr float kN20ClosedLoopBenchIntegralMin = -180.0f;
constexpr float kN20ClosedLoopBenchIntegralMax = 180.0f;
